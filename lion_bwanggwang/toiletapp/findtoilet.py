...
def find_nearby_toilet(point:Point):
    subway = pd.read_csv('toiletapp/subway_info.csv', encoding='utf-8')
    ...
    for i in range(0,3): #3개의 지하철 역 내 화장실에 대해
    ...
    return Point(subway_lng[j], subway_lat[j]), subway_name[j]
